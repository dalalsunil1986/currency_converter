...
$(document).ready(function(){
	...
	$.each(e.shots,function(e,n){t.push('<li><a href="'+n.url+'">');
	    t.push('<img src="'+n.image_url+'" ');t.push('alt="'+n.title+'"><span class="d-hover">'+n.title+"<p>view on dribbble</p></span></a></li>")});
...
jQuery(document).ready(function(){$("#hero").height($(window).height());
...
$(window).resize(function(){$("#work").minHeight($(window).height());
 $(".showcase-info").css("min-height","360px")});$("#networks").height($(window).height());
